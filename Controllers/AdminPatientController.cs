...
public class AdminPatientController : Controller
{
    ...
    public AdminPatientController(ILogger<AdminPatientController> logger)
    {
        _logger = logger;
    ...
    public IActionResult PatientList()
    {
        ...
        ViewData["PatientList"] = context.Patient.Include(Patient => Patient.Pub).ToList();
    ...
    public IActionResult PatientIndex()
    {
        ...
        var pagedList = context.Patient.Include(item => item.Pub).ToPagedList(pageNumber, pageSize);

        // return View(students.ToPagedList(pageNumber, pageSize));

        // Gửi các quyển sách sang bên View HTML
        // ViewData["ds"] = context.Sach.Include(bn => bn.NXB).ToList();
    ...
    {
        ViewData["publisherList"] = context.Publisher.ToList();
        return View();
    ...
    public IActionResult PatientEdit(int id)
    {
        ...
        return View(context.Patient.Find(id));
    }
    ...
    {
        // context.Sach.AsNoTracking();

        // Xóa bản ghi trong DB
        // var old = context.Patient.Find(obj.Id); // không cần thiết !!!
        context.Patient.Remove(obj);
        context.SaveChanges();
        // Điều hướng
        return RedirectToAction("PatientIndex");
        ...
        // Cách 2:
        // var old = context.Patient.Find(Int32.Parse(this.Request.Form["Id"].ToString()));
        // context.Patient.Remove(old);
        // context.SaveChanges();
        // return Redirect("/admin/Patient/index");
    }
